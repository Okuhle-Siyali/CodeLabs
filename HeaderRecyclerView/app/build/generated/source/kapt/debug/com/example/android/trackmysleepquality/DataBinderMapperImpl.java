...
import com.example.android.trackmysleepquality.databinding.FragmentSleepDetailBindingImpl;
...
import com.example.android.trackmysleepquality.databinding.ListItemSleepNightLinearBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  private static final int LAYOUT_FRAGMENTSLEEPDETAIL = 1;

  private static final int LAYOUT_FRAGMENTSLEEPQUALITY = 2;

  private static final int LAYOUT_FRAGMENTSLEEPTRACKER = 3;

  private static final int LAYOUT_LISTITEMSLEEPNIGHT = 4;

  private static final int LAYOUT_LISTITEMSLEEPNIGHTLINEAR = 5;

  private static final SparseIntArray INTERNAL_LAYOUT_ID_LOOKUP = new SparseIntArray(5);

  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.android.trackmysleepquality.R.layout.fragment_sleep_detail, LAYOUT_FRAGMENTSLEEPDETAIL);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.android.trackmysleepquality.R.layout.list_item_sleep_night_linear, LAYOUT_LISTITEMSLEEPNIGHTLINEAR);
  }
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        case  LAYOUT_FRAGMENTSLEEPDETAIL: {
          if ("layout/fragment_sleep_detail_0".equals(tag)) {
            return new FragmentSleepDetailBindingImpl(component, view);
          }
        ...
        case  LAYOUT_LISTITEMSLEEPNIGHTLINEAR: {
          if ("layout/list_item_sleep_night_linear_0".equals(tag)) {
            return new ListItemSleepNightLinearBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for list_item_sleep_night_linear is invalid. Received: " + tag);
        }
      }
    }
    return null;
  ...
  private static class InnerBrLookup {
    ...
    static {
      sKeys.put(0, "_all");
      sKeys.put(1, "sleep");
      sKeys.put(2, "sleepDetailViewModel");
      sKeys.put(3, "sleepTrackerViewModel");
      sKeys.put(4, "sleepQualityViewModel");
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout/fragment_sleep_detail_0", com.example.android.trackmysleepquality.R.layout.fragment_sleep_detail);
      ...
      sKeys.put("layout/list_item_sleep_night_linear_0", com.example.android.trackmysleepquality.R.layout.list_item_sleep_night_linear);
    }
  }
}
